...
📌 Users can upload custom HR datasets in .csv format for real-time analysis
...
git clone 
(https://github.com/Thejasuryachar11/Intern_HR_ANALYTICS.git)
...
Salary & Performance Correlation – Analyzed how compensation impacts performance

Workforce Diversity Trends – Examined gender and age distribution

Retention Strategy Suggestions – Offered actionable ways to reduce employee churn
...
📜 Future Improvements
 ...
 Advanced Filters & Drill-Down Options

 Integration With HRMS for real-time dashboards

🏆 Contributions

Feel free to fork this repository and contribute.
For suggestions or improvements, please open an issue or send a pull request.
